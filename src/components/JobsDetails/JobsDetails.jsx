    ...
    return (
        <div className='p-5'>
            ...
            <div className='grid md:grid-cols-4 '>
                ...
                <div className='border p-3 rounded-lg col-span-1 bg-indigo-400 text-black'>
                    ...
                    <div>
                        ...
                        <button className="btn btn-outline btn-secondary w-full flex-grow">Apply Now</button>
